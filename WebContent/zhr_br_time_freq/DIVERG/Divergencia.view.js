sap.ui.jsview("zhr_br_time_freq.DIVERG.Divergencia", {
 ...
 getControllerName : function() {
  return "zhr_br_time_freq.DIVERG.Divergencia";
 },
 ...
 createContent : function(oController) {
  ...
  // Tabela
  var oTable = new sap.m.Table(this.createId("idDivergencia"), {
  ...
  var oSalvar = new sap.m.Button(this.createId("idSalvar"), {
   ...
   press : function(oEvent) {
    var erro = oController.set_Divergence_Data(oEvent);
    if (erro == false) {
//        location.reload();
     sap.ui.controller("zhr_br_time_freq.DIVERG.Divergencia").get_Divergence_Data(
...
//    }
  ...
  var row = parseInt(oEvent.getSource().getParent().oBindingContexts.undefined.sPath.split('/')[2]);
    oController.get_Divergence_Files(oEvent, line, row);
   }
  }));
 ...
 //              this.setVisible(true)
  ...
  oRowBase.addCell(new sap.m.CheckBox({
   ...
   select : [oController.onSelCheckBox, oController]//function(oEvent) {
